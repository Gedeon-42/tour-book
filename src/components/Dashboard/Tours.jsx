...
function Tour1() {
  ...
  const displayUser = tours.slice(pageVisited,pageVisited + userPerpage).map((tour)=>(
  ...
  const pageCount = Math.ceil(tours.length/userPerpage)
  const changePage = ({selected})=>{
setPageNumber(selected)
  }
 return<div className='tour-details'>
